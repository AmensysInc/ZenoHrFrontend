...
export async function createEmployee(employee) {
  try {
      // Get recruiterId from session storage
      const recruiterId = sessionStorage.getItem("id");

      // Add recruiterId as a query parameter
      ...
      // Make the API call to "/bulkmails/save" with recruiterId as a query parameter
      const response = await post(`/bulkmails/save${queryParams}`, employee, requestOptions);
