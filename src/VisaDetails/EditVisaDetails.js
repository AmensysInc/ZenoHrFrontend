...
export default function EditVisaDetails() {
    ...
    const fetchVisaDetailsAndEmployee = async () => {
        try {
            ...
            const visaresponse = await fetch(`${apiUrl}/visa-details/${visaId}`, requestOptions);
            if (!visaresponse.ok) {
    ...
    const handleFormSubmit = async (event) => {
        ...
        try {
          ...
          const response = await fetch(`${apiUrl}/employees/visa-details/${visaId}`, requestOptions);
          if (!response.ok) {
