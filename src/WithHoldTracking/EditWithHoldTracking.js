...
export default function EditWithHoldTracking() {
  ...
  useEffect(() => {
    // Calculate actualAmt, paidAmt, and balance whenever the input values change
  ...
  return (
    <div>
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        {/* Read-only fields for actualAmt, paidAmt, and balance */}
        <div className="form-row">
          <div className="form-group">
...
export default function EditWithHoldTracking() {
  ...
  const navigate = useNavigate();
  const location = useLocation();
  const { employeeId, trackingId } = location.state;
